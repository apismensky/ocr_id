...
# It uses the gradient map to find the orientation of the text
# Assumption: Document image contains all text in same orientation
# from stackoverflow: https://stackoverflow.com/questions/52800030/how-to-correct-skew-of-an-image-using-opencv-in-python
...
if __name__ == "__main__":
    filePath = 'images/sources/WA_90.jpg'
    main(filePath)
